...
def run_query(myQuery):
    ...
    tweets = client.search_recent_tweets(query= myQuery,max_results=50, sort_order='relevancy', tweet_fields=['id','lang'])
    ...
    return tweet_link #Return list with filtered tweet links